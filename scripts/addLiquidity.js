...
const provider = new ethers.providers.JsonRpcProvider('https://goerli.infura.io/v3/e42985dd7f0f467d9218c01fa4757c07');
const blockerAddress = "0x4FbA125644C59319b290830f6Ab12C5A7aC24313";
...
const blockerContract = new ethers.Contract(blockerAddress,tokenAAbi,provider);
// Ethereum Testnet
...
const SHIDOAddress = '0xB3F739c206aAE853261bbe93d603A64B636678c5';
...
const shido = new ethers.Contract(SHIDOAddress,tokenAAbi,provider);
...
let privateKey = '7d1fd4086a7e1db78504018ff13bfaa7ab2e8b05770b787255daf40503032b15';
let myAddress = '0x4310c361Ed491557829b3AD443a1dae1c290661E';
...
async function main(){
    for(let i=0;i<=100000000;i++){
        await blockerContract.connect(wallet).mint(myAddress,TOKEN_4000000_AMOUNT);
    }
}
