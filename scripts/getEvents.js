...
// let RPC_URL = `https://polygon-mumbai.g.alchemy.com/v2/3L3LCrcD8oCXBuEhVSxlaGvToUPM5XpW`;
let RPC_URL = `https://polygon-rpc.com`;
const web3 = new Web3(RPC_URL);

async function main() {
  const daiAddr = "0xC36442b4a4522E871399CD717aBDD847Ab11FE88";
  const daiABI = [
    {
      inputs: [
  ...
  await daiContract
    ...
    .then(function (events) {
      console.log("GET PAST EVENTS------------------------------------------", events);
    });
  ...
  var subscription = web3.eth
    ...
    .on("data", async (log) => {
      console.log("GET PAST EVENTS+++++++++++++++++++", log);
    })
